                        ...
                        <div class="card-tools">
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="{{ route('admin.applications.index') }}">All</a>
                                    <a class="dropdown-item" href="{{ route('admin.applications.index', ['status' => 'draft']) }}">Draft</a>
                                    <a class="dropdown-item" href="{{ route('admin.applications.index', ['status' => 'submitted']) }}">Submitted</a>
                                    <a class="dropdown-item" href="{{ route('admin.applications.index', ['status' => 'under_review']) }}">Under Review</a>
                                    <a class="dropdown-item" href="{{ route('admin.applications.index', ['status' => 'approved']) }}">Approved</a>
                                    <a class="dropdown-item" href="{{ route('admin.applications.index', ['status' => 'rejected']) }}">Rejected</a>
                                </div>
                            </div>
                            <div class="ml-2 btn-group">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="{{ route('admin.applications.index') }}">All</a>
                                    <a class="dropdown-item" href="{{ route('admin.applications.index', ['payment' => 'paid']) }}">Paid</a>
                                    <a class="dropdown-item" href="{{ route('admin.applications.index', ['payment' => 'pending']) }}">Pending</a>
                                </div>
                            </div>
                        </div>
                    </div>
